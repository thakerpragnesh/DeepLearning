...
def compCandConvLayerBlkwise(module,blockList,blockId,st=0,en=0,k=1):
    with open(outLogFile, "a") as f:
...
def iterativePruningBlockwise(newModel,module,blockList,prune_epochs):
    ...
    for e in range(prune_epochs):
        ...
        for blkId in range(start,end):
            ...
            newList = compCandConvLayerBlkwise(module=module, blockList=blockList,
                                               blockId=blkId, st=0, en=0, k=pc[blkId])
            ...
            #newList = compCandConvLayerBlkwise(module, blockList, blockId)
        ...
        savePath = f'/home/pragnesh/Model/vgg16_IntelIc_Prune_{e}_b_train'
