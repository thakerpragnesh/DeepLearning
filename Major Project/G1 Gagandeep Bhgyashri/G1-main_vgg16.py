...
for threshold in tau_values:
    ...
    for layer in net.modules():
        ...
        if isinstance(layer, nn.Conv2d):
            ...
            n_clusters_,first_ele = cluster_weights_agglo(weight_layers_rearranged.T,
																							threshold,cosine=cosine,
																							euclidean=euclidean,
																							chebyshev=chebyshev,
																							manhattan=manhattan)
            ...
            weight_pruned = np.reshape(weight_pruned, 
																[
																n_clusters_, 
																weight_layers_rearranged_pruned.shape[1],
																weight_layers_rearranged_pruned.shape[2],
																weight_layers_rearranged_pruned.shape[3]
																]
																)
...
print(nb_remanining_filters)
print("Accuracy after pruning is = ",sum_total/num_total,"\n")
